...
import cn.chia.pay.ali.config.AlipayConfig;
import cn.chia.pay.ali.sign.MD5;
import cn.chia.pay.ali.sign.RSA;
import cn.chia.pay.ali.util.httpClient.HttpProtocolHandler;
import cn.chia.pay.ali.util.httpClient.HttpRequest;
import cn.chia.pay.ali.util.httpClient.HttpResponse;
import cn.chia.pay.ali.util.httpClient.HttpResultType;
...
//		log.debug(text);
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod, String strButtonName) {
    	...
    	AlipaySubmit.writelog("======================================================================" );
    	AlipaySubmit.writelog("AlipaySubmit buildRequest :" + ALIPAY_GATEWAY_NEW);
        //待请求参数数组
        ...
        AlipaySubmit.writelog("AlipaySubmit  sbHtml :" + sbHtml);
        AlipaySubmit.writelog("======================================================================" );
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
    	AlipaySubmit AlipaySubmit = new AlipaySubmit();
    	AlipaySubmit.writelog("======================================================================" );
    	AlipaySubmit.writelog("AlipaySubmit getRequestToken :" + ALIPAY_GATEWAY_NEW + strParaFileName + strFilePath);
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
    ...
    public static String getRequestToken(String text) throws Exception {
    	AlipaySubmit AlipaySubmit = new AlipaySubmit();
    	AlipaySubmit.writelog("======================================================================" );
    	AlipaySubmit.writelog("AlipaySubmit getRequestToken :" + text);
        ...
        AlipaySubmit.writelog("request_token: " + request_token);
        AlipaySubmit.writelog("======================================================================" );
