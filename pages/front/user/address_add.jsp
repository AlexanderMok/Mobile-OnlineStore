...
<script type="text/javascript">
	function checkForm(){
		var receiverName = document.getElementById("email").value;
			alert("收货人不能为空");
			return "false";
		}
</script>
	...
	<body>
		<s:form action="user_addAddress.action" id="table" namespace="/pages/front" method="post" theme="simple" onsubmit="return checkForm();">
			<div class="header">
			...
			<div class="middle_contacts_2">
				<div class="number2">
					...
					<div class="name">
						...
						<div class="form">
							<div class="item email">
								<s:textfield name="address.addr" placeholder="请填写收货地址"
									id="email"></s:textfield>
							</div>
						</div>
					</div>
