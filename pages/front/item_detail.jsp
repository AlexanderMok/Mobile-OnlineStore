<%@ page language="java" import="java.util.*,java.text.SimpleDateFormat,cn.chia.pojo.User" pageEncoding="UTF-8"%>
...
function addshopcar(id){
  ...
  <body>
     <div id="top">
		<div class="header">
			 <a  href="javascript:history.go(-1)" class="logo"> <img
				...
				class="logoleft"></a>
			<div class="hezi">
				<span class="title">新鲜水果</span>
			</div>
			<a  href="/IShangLifeWebSite/seller" class="logo"> <img
	...
	<div class="left">
			<div class="caidan"><a href="pages/front/finditems!findByFirstName.action?tblCatagorgy.catagorgyId=1">饼干蛋糕</a></div>
			<div class="caidan"><a href="pages/front/finditems!findByFirstName.action?tblCatagorgy.catagorgyId=2">咖啡饮料</a></div>
			<div class="caidan"><a href="pages/front/finditems!findByFirstName.action?tblCatagorgy.catagorgyId=3">蜜饯果冻</a></div>
			<div class="caidan"><a href="pages/front/finditems!findByFirstName.action?tblCatagorgy.catagorgyId=4">肉干鱼类</a></div>
			<div class="caidan"><a href="pages/front/finditems!findByFirstName.action?tblCatagorgy.catagorgyId=5">休闲食品</a></div>
			<div class="caidan"><a href="pages/front/finditems!findByFirstName.action?tblCatagorgy.catagorgyId=6">糖果</a></div>
			<div class="caidan"><a href="pages/front/finditems!findByFirstName.action?tblCatagorgy.catagorgyId=7">奇奇怪怪</a></div>	
	...
	<div class="right">
		<div id="main">			
				<table width="100%">
				  ...
				  <s:iterator value="findByFirstNameList" >
...
<!-- 底部浮动的3个导航-->
 <div class="page">
			...
			<a href="pages/back/user!findById.action?user.userid=<%=user.getUserid() %>"
				 class="link1"><img
