...
<html>
  ...
  <body>
  	<div class="top">添加客服</div>
  	<div class="main">
  	<form action="pages/back/manager-addcustomerservice" method="post">
  	<table width="77%" height="69" align="center" border="0" cellpadding="2" cellspacing="2">
        <tr>
          <th>客服名：</th>
          <td><input name="customerservice.csname"/></td>
        </tr>
        <tr>
          <th>客服电话：</th>
          <td><input name="customerservice.cstel"/></td>
        </tr>
        <tr>
          <th>密码：</th>
