...
<html>
  ...
  <body>
  	...
  	<div class="main">
  	<form action="pages/back/manager-updatecustomerservice" method="post">
  	<table width="77%" height="69" align="center" border="0" cellpadding="2" cellspacing="2">
        <tr>
          <th>配送人名：</th>
          <td>${customerservice.csname}</td>
        </tr>
        <tr>
          <th>配送人联系方式：</th>
          <td><input name="customerservice.cstel" value="${customerservice.cstel}"/></td>
        </tr>
       </table>
