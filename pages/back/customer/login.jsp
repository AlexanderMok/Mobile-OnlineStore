...
<html>
  <head>
	...
	-->
	<link href="source/back/css/login.css" type="text/css" rel="stylesheet" />
	<script src="source/back/js/jquery-1.4.2.min.js"></script>
	<script src="source/back/js/login.js"></script>
  </head>
   <body>
<table cellspacing="0" cellpadding="0" width="100%" bgcolor="#002779" border=0 style="margin-top:100px" align="center">
  <tr>
    ...
    <table cellspacing=0 cellpadding=0 width=468 border=0 align="center">
        <tr>
          <td><img height=23 src="source/back/images/login_1.jpg" width="468" /></TD>
        </tr>
        <tr>
          <TD><img height=147 src="source/back/images/login_2.jpg" width=468 /></TD>
        </tr>
     </table>
      <TABLE cellSpacing=0 cellPadding=0 width=468 bgColor=#ffffff border=0 align="center">
        <tr>
          <TD width=16><IMG height=122 src="source/back/images/login_3.jpg" 
            width=16></TD>
          <td align="center">
          
          <form onsubmit="return false;" action="pages/back/customer-chklogin" method="post" id="form_login">
          	<table width=366 border=0 align="center" cellPadding=0 cellSpacing=0>
                <tr>
                  <TD width="50" height="30">用户名：</TD>
                  <TD width="150" align="left"><input name="csname" id="username" class="input" maxlength="10" /></TD>
                  
                  <TD width="166" align="left"><span id="error_name" style="color:#FF0000;">${error}</span></td>
                </tr>
                <tr>
               ...
               <input type="password" name="password" id="password" class="input" maxlength="10" /></TD>
                ...
                <tr height=28>
                  ...
                  <img id="imgCode" onclick="reflashCode()" src="image.do" align="absbottom" style="cursor:pointer;">&nbsp;&nbsp;&nbsp;<span id="error_verify"  style="color:#FF0000;">${error2}</span></TD>
                </tr>
                <tr height=5>
                  <TD colSpan=3></TD>
                </tr>
          ...
          <TD width=16><IMG height=122 src="source/back/images/login_4.jpg" 
            width=16></TD>
        </tr>
      </TABLE>
      <TABLE cellSpacing=0 cellPadding=0 width=468 border=0 align="center">
        <tr>
          <TD><IMG height=16 src="source/back/images/login_5.jpg" 
          width=468></TD>
        </tr>
      </TABLE></TD>
  </tr>
