...
<html>
  ...
  <body onload="startTime()">
	...
	<font color="red" size="3">${sessionScope.onmanager.userName}</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red" size="3">管理员</font></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<a href="pages/back/manager-logout" onclick="javascript:return confirm('您确定退出吗？')" target="_parent">退出系统</a>	 
	</div>
