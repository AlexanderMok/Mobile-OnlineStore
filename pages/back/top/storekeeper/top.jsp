...
<html>
  ...
  <body onload="startTime()">
	...
	<div class="center" style="z-index: 99999">
	<span style="color:#FFFFFF;">
	<font color="red" size="3">${sessionScope.onstorekeeper.userName}</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red" size="3">仓管员</font></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<a href="pages/back/storekeeper-logout" onclick="javascript:return confirm('您确定退出吗？')" target="_parent">退出系统</a>	 
	</div>
